...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
  ...
  function srcAppRestApiServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var apiUrlCategory = "http://laboweb.ecam.be/notepad_s4/public/index.php/api/categories";
    var apiUrlNote = "http://laboweb.ecam.be/notepad_s4/public/index.php/api/notes";
    ...
    var RestApiService = /*#__PURE__*/function () {
      ...
      _createClass(RestApiService, [{
        ...
        key: "getClassroom",
        value: function getClassroom() {
          return this.http.get(apiUrlCategory, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(this.extractData), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
        }
      }, {
        key: "getClassroomById",
        value: function getClassroomById(id) {
          var url = "".concat(apiUrlCategory, "/").concat(id);
        ...
        key: "postClassroom",
        value: function postClassroom(data) {
          var url = "".concat(apiUrlCategory);
          console.log(data);
        ...
        key: "updateClassroom",
        value: function updateClassroom(id, data) {
          var url = "".concat(apiUrlCategory, "/").concat(id);
        ...
        value: function getNotes() {
          return this.http.get(apiUrlNote, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(this.extractData), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
        }
      }, {
        key: "getNoteById",
        value: function getNoteById(id) {
          var url = "".concat(apiUrlNote, "/").concat(id);
          return this.http.get(url, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(this.extractData), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
        }
      }, {
        key: "postNote",
        value: function postNote(data) {
          var url = "".concat(apiUrlNote);
          console.log(data);
          return this.http.post(url, data, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
        }
      }, {
        key: "updateNote",
        value: function updateNote(id, data) {
          var url = "".concat(apiUrlNote, "/").concat(id);
          return this.http.put(url, data, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
        }
      }, {
    ...
    RestApiService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"]])], RestApiService);
    /***/
  }
}]);
